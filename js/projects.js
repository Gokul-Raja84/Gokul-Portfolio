      ...
      if (response.ok) {
          ...
          for (let i in data) {
            switch (data[i].name) {
              case HARRY_DULANEY_COM:
                ...
                let hdComStats = document.getElementById(
                  "harrydulaney-com-stats"
                );
                let hdComUpdateTime =
                  hdComStats.getElementsByClassName("git-stats-datetime");
                let hdComStars = document.getElementById(
                  "harrydulaney-com-stars"
                );
                let hdComForks = document.getElementById(
                  "harrydulaney-com-forks"
                );
              ...
              case PFOLIE:
                ...
                let pfolieUpdateTime =
                  pfolieStats.getElementsByClassName("git-stats-datetime");
              ...
              case SPREADSHEET_BUDDY:
                ...
                let ssbUpdateTime =
                  ssbStats.getElementsByClassName("git-stats-datetime");
              ...
              case DEEZER_APP:
                ...
                let deezerUpdateTime =
                  deezerStats.getElementsByClassName("git-stats-datetime");
              ...
              case INTRO_JAVA:
                ...
                let introJavaStats = document.getElementById(
                  "intro-java-app-stats"
                );
                let introJavaUpdated =
                  introJavaStats.getElementsByClassName("git-stats-datetime");
                let introToJavaStars = document.getElementById(
                  "intro-java-program-stars"
                );
                let introToJavaForks = document.getElementById(
                  "intro-java-program-forks"
                );
              ...
              case FILE_COMM:
                ...
                let fileCommStats = document.getElementById(
                  "file-commander-stats"
                );
                let fileCommUpdated =
                  fileCommStats.getElementsByClassName("git-stats-datetime");
                let fileCommStars = document.getElementById(
                  "file-commander-stars"
                );
                let fileCommForks = document.getElementById(
                  "file-commander-forks"
                );
              ...
              case NOTES_ANDROID:
                ...
                let notesStats = document.getElementById(
                  "notes-4-android-stats"
                );
                let updateDateTime =
                  notesStats.getElementsByClassName("git-stats-datetime");
                let notesStars = document.getElementById(
                  "notes-4-android-stars"
                );
                let notesForks = document.getElementById(
                  "notes-4-android-forks"
                );
              ...
              case STOCK_PREDICTOR:
                ...
                let stockPredStats = document.getElementById(
                  "stock-predictor-stats"
                );
                let updateTime =
                  stockPredStats.getElementsByClassName("git-stats-datetime");
                let stockPredStars = document.getElementById(
                  "stock-predictor-stars"
                );
                let stockPredForks = document.getElementById(
                  "stock-predictor-forks"
                );
        ...
        response.json().then((data) => {
          if (Object.hasOwn(data, "errors")) {
            console.log(
              "Following error's occurred while calling GitHub API..."
            );
