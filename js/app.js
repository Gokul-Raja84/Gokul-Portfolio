...
$(window).ready(function () {
  ...
  $(
    "#mobile-menu-intro,#mobile-menu-projects,#mobile-menu-about,#mobile-menu-contact, #mobile-menu-downloads"
  ).on("click", function () {
    if (open) {
      retractMobileMenu();
      $("#mobile-nav-icon").removeClass("open");
...
function resetActiveNavItems() {
  let navElementIds = [
    NAV_MENU_INTRO_ID,
    NAV_MENU_PROJECTS_ID,
    NAV_MENU_ABOUT_ID,
    NAV_MENU_CONTACT_ID,
    NAV_MENU_DOWNLOADS_ID,
  ];
  if (isMobile.matches) {
    navElementIds = [
      NAV_MOBILE_INTRO_ID,
      NAV_MOBILE_PROJECTS_ID,
      NAV_MOBILE_ABOUT_ID,
      NAV_MOBILE_CONTACT_ID,
      NAV_MOBILE_DOWNLOADS_ID,
    ];
  }
...
function setLightTheme(page) {
  switch (page) {
    ...
    case "about":
      clearIntroAnimation();
      $(".about-me-bg-overlay").css(
        "background",
        'url("./assets/img/graphics/undraw_moonlight_-5-ksn-light.svg") no-repeat center'
      );
...
function setDarkTheme(page) {
  switch (page) {
    ...
    case "about":
      ...
      $(".about-me-bg-overlay ").css(
        "background",
        'url("./assets/img/graphics/undraw_moonlight_-5-ksn.svg") no-repeat center'
      );
      $(".about-me-bg-overlay ").css("position", "relative");
      $(".about-me-bg-overlay ").css("display", "block");
      $(".about-me-bg-overlay ").css("background-size", "contain");
